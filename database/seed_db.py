...
users = [
    ...
    (26, 'PAT_0009', 'pat_zhouhq', '$2a$10$wTfq7L2N4e0p/92hC9k/5e3bA/bYv18L/v4mUvPsm71uLw74m9bF2', '周华强', 'patient', 0, 0, '患者(艾滋病携带)', '13900000009', '110101198409121234', 'NORMAL'),
    (27, 'PAT_0010', 'pat_linxz', '$2a$10$wTfq7L2N4e0p/92hC9k/5e3bA/bYv18L/v4mUvPsm71uLw74m9bF2', '林秀芝', 'patient', 0, 0, '患者(活动性肺结核)', '13900000010', '310101197911053321', 'NORMAL'),
...
records_data = [
    # 1. 张三 (第一人民医院 - 心血管内科) - 伴慢性乙肝(HBV)病毒携带史
    (1, 'REC202609001', 4, 1, 1, 'EMR',
     '2026-09-01 08:30', '持续3天，劳累后加重',
     '胸骨后压榨样闷痛、伴心悸气促，夜间偶有阵发性呼吸困难',
     '连续夜班过度劳累诱发；既往高血压病史8年未规律服药；明确慢性乙型病毒性肝炎(HBV)大三阳病毒携带10年(HBsAg阳性)，锐器操作需严密防范刺伤；对青霉素、头孢类抗生素有明确严重过敏史',
     '1. 完善12导联心电图与心肌酶谱复查；2. 硝苯地平缓释片30mg qd降压；3. 严禁使用β-内酰胺类药物；4. 医护人员严格落实防刺伤职业暴露防护规程',
     '体温: 36.6℃ | 血压: 155/98 mmHg | 心率: 88 bpm | 血氧: 98%',
     '【主诉】患者因“胸骨后闷痛3天加重半天”就诊。\n【现病史与诱因】于2026-09-01 08:30发病，劳累诱发，持续3天。\n【既往传染病史】慢性乙型病毒性肝炎 (HBV) 大三阳终身/慢性病毒携带 (HBsAg阳性)，存在血源性职业暴露风险！\n【初步诊断】高血压病II级（中危）；心绞痛待查；慢性乙型病毒性肝炎携带；严重过敏体质。\n【处置建议】降压治疗、心电监护，抽血穿刺必须佩戴双层手套，禁用青霉素头孢。',
    ...
    # 13. 周华强 (协和医学中心 - 感染与热带病医学科) - 艾滋病(HIV/AIDS)确诊必定终身携带
    (14, 'REC20260810C05', 26, 15, 3, 'EMR',
     '2026-08-10 10:00', '发热乏力伴体重下降1个月',
     '发热伴全身多发浅表淋巴结肿大，夜间盗汗，纳差消瘦，易反复口腔真菌感染',
     '人类免疫缺陷病毒(HIV-1)感染，必定终身携带，免疫功能低下(CD4计数 180 cells/uL)；医护职业暴露极高危(血液体液/针刺伤)',
     '1. 规范启动国家免费一线免费抗病毒治疗(ART)：替诺福韦+拉米夫定+多替拉韦；2. 口服复方磺胺甲噁唑预防卡氏肺孢子虫肺炎；3. 严格落实医务人员标准预防与双层手套、面屏防溅职业暴露安全防护规程',
     '体温: 37.6℃ | 血压: 115/75 mmHg | 心率: 86 bpm | 血氧: 98%',
     '【协和感染科最终确诊】获得性免疫缺陷综合征 (AIDS)；人类免疫缺陷病毒感染 (HIV抗体确证试验阳性，必定终身携带)；口腔念珠菌感染。【医护安全警报】该患者为血源性高危传染病确诊携带者，侵入性操作严防锐器刺伤，穿戴双层手套及防溅面屏！',
     '0xe5f7a9b1c3d6e8f0a2b4c6d8e0f2a4b6c8e0f2a4b6c8e0f2a4b6c8e0f2a4b6c8', 170, '2026-08-10 11:30:00'),

    # 14. 林秀芝 (第一人民医院 - 呼吸与危重症医学科) - 活动性耐多药肺结核(MDR-TB)飞沫呼吸道高危
    (15, 'REC20260820A05', 27, 9, 1, 'EMR',
     '2026-08-20 09:15', '阵发性咳嗽咳痰2个月，咯血3天',
     '咳嗽、咳大量黄脓痰，午后潮热(T: 38.2℃)，夜间盗汗，近3天出现痰中带鲜血丝，活动后胸闷气促',
     '结核分枝杆菌耐多药复合株感染，处于活动期持续排菌状态；呼吸道飞沫与气溶胶传播风险极高',
     '1. 立即收住负压结核呼吸隔离病房，严格实施空气与飞沫隔离；2. 二线耐多药结核方案抗感染：贝达喹啉+利奈唑胺+环丝氨酸；3. 接诊医护人员必须严格佩戴 N95 医用防护口罩与防护面罩',
     '体温: 38.2℃ | 血压: 122/78 mmHg | 心率: 96 bpm | 血氧: 94%',
     '【第一医院呼吸科确诊】继发性活动性肺结核 (涂阳排菌型)；耐多药结核 (MDR-TB)；支气管扩张伴小量咯血。【医护安全警报】患者痰抗酸杆菌涂片(+++)，活动期强排菌，空气飞沫高度传染，接诊医护必须严格穿戴N95口罩与医用隔离衣！',
     '0xf6a8b0c2d4e7f9a1b3c5e7f9a1b3c5e7f9a1b3c5e7f9a1b3c5e7f9a1b3c5e7f9', 171, '2026-08-20 10:45:00'),
]
...
# 5. 预置 14 份病历的对应影像切片与加密文件 (IPFS CID 与 SHA-256)
files_data = [
    ...
    (13, 14, 'HIV感染与免疫功能确证报告单_周华强_REC20260810C05.pdf', 'pdf', 1450000, 'QmAbCdEf11js82ks7shk92hs78bsh28s7shxmslwoe827shg', 'a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2', '2026-08-10 11:30:00'),
    (14, 15, '痰结核分枝杆菌涂片与耐药基因筛查_林秀芝_REC20260820A05.pdf', 'pdf', 1680000, 'QmBcDeFg21js82ks7shk92hs79bsh28s7shxmslwoe827shh', 'b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3', '2026-08-20 10:45:00'),
]
for f in files_data:
    cur.execute("""
